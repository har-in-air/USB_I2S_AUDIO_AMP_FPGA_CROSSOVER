...
#include "../../../../usb/Class/AUDIO/Inc/usbd_audio.h"

#include "../../../../usb/Core/Inc/usbd_ctlreq.h"
#include "bsp_audio.h"
...
#define AUDIO_FB_DEFAULT 0x0BFF6DB2 // I2S_Clk_Config24[1].nominal_fdbk (48kHz, 24bit, USE_MCLK_OUT true)
...
__ALIGN_BEGIN static uint8_t USBD_AUDIO_CfgDesc[USB_AUDIO_CONFIG_DESC_SIZ] __ALIGN_END = {
    ...
    0x00, /* iConfiguration */
    0xC0, /* bmAttributes  BUS Powered (B0 = buspowered, 0xC0 = self-powered) */
    ...
    0x02,                            /* bSamFreqType 2 frequencies supported */
...
/**
  ...
  *         handle SOF event
  *         Ensure Sof_enable is 1 in USBD_LL_Init for this function to be called
  * @param  pdev: device instance
  * @retval status
  */
static uint8_t USBD_AUDIO_SOF(USBD_HandleTypeDef* pdev)
