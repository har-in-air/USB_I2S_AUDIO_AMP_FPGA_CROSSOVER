...
#ifndef DRIVERS_BSP_TAS5753MD_H_
#define DRIVERS_BSP_TAS5753MD_H_

#define TAS5753MD_PIN_PSW       GPIO_PIN_1
#define TAS5753MD_PIN_RST		GPIO_PIN_0

#define TAS5753MD_PIN_PDN       GPIO_PIN_6

#define TAS5753MD_PSW_LO() 	HAL_GPIO_WritePin(GPIOC, TAS5753MD_PIN_PSW, GPIO_PIN_RESET)
#define TAS5753MD_PSW_HI() 	HAL_GPIO_WritePin(GPIOC, TAS5753MD_PIN_PSW, GPIO_PIN_SET)

#define TAS5753MD_PDN_LO() 	HAL_GPIO_WritePin(GPIOA, TAS5753MD_PIN_PDN, GPIO_PIN_RESET)
#define TAS5753MD_PDN_HI() 	HAL_GPIO_WritePin(GPIOA, TAS5753MD_PIN_PDN, GPIO_PIN_SET)

#define TAS5753MD_RST_LO() 	HAL_GPIO_WritePin(GPIOC, TAS5753MD_PIN_RST, GPIO_PIN_RESET)
#define TAS5753MD_RST_HI() 	HAL_GPIO_WritePin(GPIOC, TAS5753MD_PIN_RST, GPIO_PIN_SET)


// 7-bit slave device addresses for the two stereo modules
#define TAS5753MD_I2C_ADDR_0  ((uint8_t)0x2A<<1)
#define TAS5753MD_I2C_ADDR_1  ((uint8_t)0x2B<<1)
...
#endif /* DRIVERS_BSP_TAS5753MD_H_ */
